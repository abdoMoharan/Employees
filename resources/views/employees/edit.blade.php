...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">{{ __('Update Employees') }}
                <a href="{{ route('employees.index') }}" class="btn btn-primary mb-2 float-right">back</a>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.update',$employee->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select form-control" aria-label="Default select example"
                                    name="department_id">
                                    <option selected disabled value="{{ $employee->department->id }}">{{ $employee->department->name }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select form-control" aria-label="Default select example"
                                    name="country_id">
                                    <option selected disabled value="{{ $employee->country->id }}">{{ $employee->country->name }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select form-control" aria-label="Default select example"
                                    name="state_id">
                                    <option selected disabled value="{{ $employee->state->id }}">{{ $employee->state->name }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select form-control" aria-label="Default select example"
                                    name="city_id">
                                    <option selected disabled value="{{ $employee->city->id }}">{{ $employee->city->name }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="zip_code" type="text"
                                    ...
                                    value="{{ old(' zip_code ',$employee->zip_code) }}" required autocomplete="zip_code" autofocus>
                                @error('zip_code')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
